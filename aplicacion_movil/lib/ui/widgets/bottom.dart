...
import 'package:demo/ui/widgets/canvas.dart' as canvas;
import 'dart:math';
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Expanded(
            child:
                Emocion(texto: "Asombrado", tamano: numero.nextDouble() * 80),
          ),
        ],
      ),
    );
...
class _EmocionState extends State<Emocion> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation =
        Tween<double>(begin: 0.0, end: valor).animate(animationController);
